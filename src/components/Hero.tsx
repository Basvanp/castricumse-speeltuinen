...
const Hero: React.FC<HeroProps> = ({ onSearch }) => {
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden -mt-16 z-10">
      ...
      <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        {/* Animated Subtitle */}
        <p 
          className="mb-8 opacity-90 animate-fade-in-up"
          style={{
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
            ...
            <Button
              type="submit"
              className="px-8 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2"
            >
