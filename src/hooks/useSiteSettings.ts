...
const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  instagram_url: '',
  twitter_url: '',
  meta_title: 'Speeltuinen Castricum - Interactieve Kaart & Gids',
  meta_description: 'Ontdek alle speeltuinen in Castricum met onze interactieve kaart. Vind de perfecte speelplek voor jouw kinderen - van peuters tot tieners!',
